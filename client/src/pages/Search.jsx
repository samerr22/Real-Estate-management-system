...
export default function Search() {
  ...
  const handleSubmit = (e) => {
    ...
    urlParmas.set("type", sidebardata.type);
    urlParmas.set("parking", sidebardata.parking);
    urlParmas.set("furnished", sidebardata.furnished);
    urlParmas.set("offer", sidebardata.offer);
    urlParmas.set("sort", sidebardata.sort);
    urlParmas.set("order", sidebardata.order);
